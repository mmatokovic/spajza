defmodule Spajza.StorageAreas do
  @moduledoc """
  ...
  ## Examples
      ...
      %Ecto.Changeset{data: %StorageArea{}}

  """
  def change_storage_area(%StorageArea{} = storage_area, attrs \\ %{}) do
    StorageArea.changeset(storage_area, attrs)
  end
end
